...
import { RuleSection } from "../../../src/types/index.js";

describe("MarkdownFormatter Units", () => {

  const sampleSections: Record<string, RuleSection> = {
    setup: {
      title: "Game Setup",
  ...
  describe("generateMarkdown", () => {
    ...
    it("should cap heading prefixes to a maximum of 6 (# symbols)", () => {
      const deepSections: Record<string, RuleSection> = {
        deep: {
          title: "Deep Section"
        }
      };
    ...
    it("should omit content or examples if they are not provided", () => {
       const minimalSection: Record<string, RuleSection> = {
