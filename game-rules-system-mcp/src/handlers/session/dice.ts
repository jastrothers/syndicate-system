...
export const rollDiceTool: ToolDefinition = {
  name: "roll_dice",
  description:
    "Rolls dice using standard notation (e.g. '2d6', '1d20+5'). Supports deterministic rolls via an optional seed. When a sessionId is provided, the roll is logged to the session ledger.",
  schema: z.object({
    notation: z
      .string()
