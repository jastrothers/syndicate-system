...
import { createDesignSession, getDesignSession, addDesignStep, listDesignSessions, saveDesignSession, } from "../../../src/services/DesignStore.js";
describe("DesignStore Units", () => {
    ...
    it("getDesignSession throws for non-existent session", async () => {
        await assert.rejects(() => getDesignSession(testGame, "non-existent-uuid"), /Design session non-existent-uuid not found/);
    });
