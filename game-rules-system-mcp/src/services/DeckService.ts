...
export interface FilterClause {
  ...
  // value is intentionally `any` — it mirrors user-provided filter values from Zod input
 ...
 */
export function matchesFilter(item: unknown, filter: FilterClause): boolean {
