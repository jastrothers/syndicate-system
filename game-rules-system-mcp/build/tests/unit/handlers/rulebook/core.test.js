...
import { compareRulebooksTool, getRulebookStructureTool, readRuleSectionTool, updateRuleTool, deleteRuleTool, } from "../../../../src/handlers/rulebook/core.js";
// ── compare_rulebooks ─────────────────────────────────────────────────────────
...
describe("getRulebookStructureTool", () => {
    ...
    it("schema defaults rulebookName to 'rulebook'", () => {
        ...
        assert.ok(result.success);
        assert.equal(result.data.rulebookName, "rulebook");
    });
});
// ── read_rule_section ─────────────────────────────────────────────────────────
